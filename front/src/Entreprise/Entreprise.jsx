      ...
      <>
        ...
        <div className="flex min-h-screen">
          ...
          <div className="bg-gray-100 p-8 w-2/3">
            ...
            {/* Affichage de la liste des videastes */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {chaines.map((chaine) => (
                <Link key={chaine.cha_id} to={`/entreprise/${chaine.cha_id}`} className="block p-4 bg-white rounded-lg shadow-md hover:bg-gray-100">{chaine.cha_name}</Link>
              ))}
            </div>
          </div>
        </div>
